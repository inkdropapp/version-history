...
* **Bugfix**: Avoid duplicate keybinding for cmd-u & ctrl-u (Thanks, [Otawara-san](https://forum.inkdrop.info/t/ctrl-u/283/4)) * **Bugfix**: Avoid duplicate keybinding for cmd-u & ctrl-u (Thanks, Otawara-san)
